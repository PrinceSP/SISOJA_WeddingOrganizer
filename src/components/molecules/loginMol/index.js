...
const LoginMol = ({valEmail,valPass,changeEmail,changePass,onPress}) => {
  return (
    <View style={{alignItems:'center',position:'absolute',top:200}}>
      ...
      <Inputs holder='Password' value={valPass} onChangeText={changePass} secureTextEntry={true}/>
      <Buttons fSize={20} width={362} title='Login' bgColor='#FF8527' color='#fff' radius={8} height={54} onPress={onPress}/>
    </View>
  )
}
